...
# ML Preprocessing
## Final Recipe From data_preparation.R ----
## 
...
h2o.getModel("StackedEnsemble_AllModels_AutoML_20210127_090045")
...
# Load Models
for(i in 1) {
  h2o.loadModel(glue("{wd}/04_Modeling/h2o_models/{automl_models_h2o@leaderboard %>% extract_model_name_by_position(i)}"))
}

# Single model
h2o.loadModel(path = "04_Modeling/h2o_models/StackedEnsemble_AllModels_AutoML_20210127_090045")


# Making Predictions 2021/01/27 ----
stacked_ensemble_model <- h2o.loadModel(
  "04_Modeling/h2o_models/StackedEnsemble_AllModels_AutoML_20210127_090045")

stacked_ensemble_model

predictions <- h2o.predict(stacked_ensemble_model,  newdata = as.h2o(test_tbl))
...
h2o.auc(stacked_ensemble_model, train = T, valid = F, xval = T)

h2o.mae(stacked_ensemble_model, train = T, valid = F, xval = T)
